classdef carFsConfigAccel
    ...
    methods
        function obj = carFsConfigAccel(filename)
...
5900	,80000];
            ...
            %                     ] ;
            % obj.motor_model_front(:,2) = obj.motor_model_front(:,2)*2; 
            obj.motor_model_rear = obj.motor_model_front;
