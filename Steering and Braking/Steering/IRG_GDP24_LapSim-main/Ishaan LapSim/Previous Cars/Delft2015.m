...
energy_generated
    ...
    methods
        ...
        function obj = Delft2015()
            ...
            obj.wheelbase = 1530E-3; %m      
            obj.trackF = 1200E-3; %m           
            obj.trackR = 1200E-3; %m           
            obj.track = (obj.trackF + obj.trackR)/2; 
            obj.CLA = -3.24; %Unknown currently, using the GDP 2022 values.    
        ...
        +K_RollR/trackR,    +wBase*K_RR/2, -K_RR];
            ...
            obj.engine_model = [ 1104.075617,6591.647219;
1471.338551,	14251.9736;
1693.617238,	17175.03609;
1942.880374,	18991.1828;
3730.714504,	41849.12408;
4118.558797,	49134.50092;
4304.705763,	52944.84674;
4500,	56551.60858;
4725.022868,	59360.26524;
4973.828641,	61222.85512;
5419.300742,	66962.4161;
5660.331334,	69116.55236;
6037.198902,	70241.46181;
6395.771928,	67381.13409;
