...
energy_generated
    ...
    methods
        ...
        function obj = Catalunya2016()
            ...
            obj.trackF = 1150E-3; %m           
            obj.trackR = 1100E-3; %m           
            obj.track = (obj.trackF + obj.trackR)/2; 
            obj.CLA = -0.05; %Unknown currently, using the GDP 2022 values.    
            obj.CDA = 1.15; %Unknown currently, using the GDP 2022 values.  
