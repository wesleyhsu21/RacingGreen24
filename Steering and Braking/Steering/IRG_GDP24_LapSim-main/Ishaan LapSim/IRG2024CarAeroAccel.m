classdef IRG2024CarAeroAccel
    ...
    methods
        ...
        function obj = IRG2024CarAeroAccel()

            obj.wheel_rad = 232.41E-3; %m
            obj.mass = 266; %kg
            obj.cog_height = 0.32372; %Unknown currently, using the GDP 2022 values.
            obj.cog_split = 0.49809;  %Unknown currently, using the GDP 2022 values.
            obj.cog_LR_split = 0.5;    
            obj.cop_height = 0.36545; %Unknown currently, using the GDP 2022 values.
            obj.cop_split = 0.21801; %Unknown currently, using the GDP 2022 values.
...
%             obj.pCLA = 3; %No. of tesing points of sensitivity on CL, higher means more detailed but takes longer to run.
            obj.CDA = 0.89252; %Unknown currently, using the GDP 2022 values.  
