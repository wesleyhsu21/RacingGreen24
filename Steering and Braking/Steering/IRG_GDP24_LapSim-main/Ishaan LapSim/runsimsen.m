function [simAccelerationArray, simEndurance_EfficiencyArray, simSkidpadArray, simSprintArray,sensiresult] = runsimsen(car,carAccel,n,trackSelect)
...
parfor i = 1 : k
    for j = 1:l
        ...
        carArrayAccel{i,j}.CDA = lbCDA + (i-1)*step_CDA;
...
y = linspace(lbCDA,ubCDA,l);
[X,Y] = meshgrid(x,y); %Idea to use meshgrid from MathWorks, 2023. 
z = overallPoints;
