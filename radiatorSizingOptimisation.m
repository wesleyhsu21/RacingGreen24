...
xlabel("Volumetric Flow Rate, CFM $ft^3/min$", "Interpreter", "Latex", 'FontSize', 14)
ylabel("Radiator Area in $cm^2$", "Interpreter", "Latex", 'FontSize', 14)
axis auto

yyaxis right;
plot(CFM(217:end), radiatorAssembly_total_mass(217:end), "-", MarkerSize=12)
xlabel("Volumetric Flow Rate, (CFM) $ft^3/min$", "Interpreter", "Latex", 'FontSize', 14)
ylabel("Radiator Mass in kg", "Interpreter", "Latex", 'FontSize', 14)
axis auto
legend("Radiator Area, $cm^2$", "Radiator Mass, $kg$", "Interpreter", "Latex", 'FontSize', 14)
