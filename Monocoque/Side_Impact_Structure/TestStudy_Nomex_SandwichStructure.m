...
c = 55e-3;% Thickness of the foam core

%% Dimensions and properties
E_c = 140e6;% Modulus of the foam core in Pa
d = c + thickness_0;
G_c = 40e6;% Shear modulus of the foam core in Pa
...
tau_critical_core = 0.5e6;% Critical core shear stress
sigma_critical_core = 0.5e6;% Critical stress same due to isotropic
rho_fc = 1570;% Facesheet density in kgm^-3
rho_c = 48;% Core density in kgm^-3
