...
connections = {
    ...
    'Power Distribution PCB', {'MCU','MCU Relay','Ground Measurement Sensor','EMRAX Pressure Sensor',...
    'Front Motors Pressure Sensor','Rear Motors Pressure Sensor','TS Temperature Sensor','Motor Temperature FL',...
    'Motor Temperature FR','Motor Temperature Rear', 'AMS/IMD','TS Current Sensor', 'BSPD', 'Inertia Sensor',...
    'Telemetry Microcontroller','Precharge Relay','Dashboard','Coolant Temp Sensor','Throttle Position Sensor',...
    'Brake Pressure Sensor','Speed Sensor RPM','Speed Sensor electronic','Brake Temperature Sensor FL',...
    'Brake Temperature Sensor FR','Brake Temperature Sensor RL','Brake Temperature Sensor RR',...
    'Tyre Temperature Sensor FL','Tyre Temperature Sensor FR','Tyre Temperature Sensor RL','Tyre Temperature Sensor RR',...
    'Tyre Pressure Sensor FL','Tyre Pressure Sensor FR','Tyre Pressure Sensor RL','Tyre Pressure Sensor RR',...
    'Steering Angle Sensor'};
    'Telemetry Microcontroller', {'Coolant Temp Sensor','EMRAX Pressure Sensor','Front Motors Pressure Sensor',...
    'TS Temperature Sensor','Rear Motors Pressure Sensor','Motor Temperature FL','Motor Temperature FR',...
    'Motor Temperature Rear','TS Current Sensor','Throttle Position Sensor','Brake Pressure Sensor','Dashboard',...
    'Speed Sensor RPM','Speed Sensor electronic','Brake Temperature Sensor FL','Brake Temperature Sensor FR',...
    'Brake Temperature Sensor RL','Brake Temperature Sensor RR','Tyre Temperature Sensor FL',...
    'Tyre Temperature Sensor FR','Tyre Temperature Sensor RL','Tyre Temperature Sensor RR','Tyre Pressure Sensor FL',...
    'Tyre Pressure Sensor FR','Tyre Pressure Sensor RL','Tyre Pressure Sensor RR','Steering Angle Sensor'};
